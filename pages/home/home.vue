<template>
  <view>
    ...
    <!-- 分类导航区域 -->
    <view class="nav-list">
      <view class="nav-item" @click="navClickHandler(item)" v-for="(item,index) of navList" :key="index">
      ...
      <view class="floor-item" v-for="(item,index) of floorList" :key="index">
        ...
        <view class="floor-img-box">
          ...
          <view class="right-img-box">
            <navigator class="item-img-box" :url="item2.url" v-for="(item2,index2) of item.product_list" :key="index2"
              v-if="index2 !== 0">
